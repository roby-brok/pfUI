...
resetcache:SetScript("OnEvent", function()
  ...
  -- only the gear scan is inventory/login specific; talent & skill events must
  -- skip this block and fall through to the cache-invalidation loop below so a
  -- respec actually refreshes cached heal amounts
