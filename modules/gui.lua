  ...
  do -- Generate Config UI
    CreateGUIEntry(T["About"], nil, function()
      ...
      github:SetScript("OnClick", function()
        pfUI.chat.urlcopy.CopyText("https://github.com/roby-brok/pfUI")
      end)
      SkinButton(github)
    ...
    CreateGUIEntry(T["Nameplates"], nil, function()
      ...
      CreateConfig(U["nameplates"], T["Vertical Offset"], C.nameplates, "vertical_offset", nil, nil, nil, nil, nil, "vanilla")
      ...
      CreateConfig(U["nameplates"], T["Target Nameplate Symbol Font"], C.nameplates, "targetsymbolfont", "dropdown", pfUI.gui.dropdowns.fonts)
    ...
    CreateGUIEntry(T["Thirdparty"], T["Integrations"], function()
      ...
      CreateConfig(nil, "TW/OW Threatmeter (" .. T["Skin"] .. ")", C.thirdparty.twt, "skin", "checkbox", nil, nil, nil, nil, "vanilla")
      CreateConfig(nil, "TW/OW Threatmeter (" .. T["Dock"] .. ")", C.thirdparty.twt, "dock", "checkbox", nil, nil, nil, nil, "vanilla")
