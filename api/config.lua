...
function pfUI:LoadConfig()
  ...
  pfUI:UpdateConfig("appearance", "worldmap",    "mousezoom",        "1")
  ...
  pfUI:UpdateConfig("nameplates", nil,           "targetsymbolfont", "Interface\\AddOns\\pfUI\\fonts\\PT-Sans-Narrow-Bold.ttf")
